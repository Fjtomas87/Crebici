...
<form action="index.php?p=registro" method="POST" class="m-1 p-1 container justify-content-center">
    ...
    <div class="form-group">
        <label class="p-1 mt-2 w-50 w-md-25" for="nombre">Nombre</label>
        <div class="div-input">    
            <input type="text" name="nombre" id="nombre" class="form-control col-sm-8">
    ...
    <div class="form-group">
        ...
        <div class="div-input"> 
            <input type="text" id="apellido1" name="apellido1" class="form-control col-sm-8">
            <span class="help-block"></span>
        </div>
    </div>        
    <div class="form-group">
        ...
        <div class="div-input"> 
            <input type="text" id="apellido2" name="apellido2" class="form-control col-sm-8">
            <span class="help-block"></span>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="div-input"> 
            <input type="password" id="pass1" name="pass1" class="form-control col-sm-8">
            <span class="help-block"></span>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="div-input">
            <input type="password" id="pass2" name="pass2" class="form-control col-sm-8">
            <span class="help-block"></span>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="div-input"> 
            <input type="text" id="dni" name="dni" class="form-control col-sm-8">
            <span class="help-block"></span>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="div-input">
            <input type="text" id="direccion" name="direccion" class="form-control col-sm-8">
            <span class="help-block"></span>
        </div>
    </div>
    <br>
