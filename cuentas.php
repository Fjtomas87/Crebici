                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>?p=cuentas" method="POST" id="form0" class="m-3 p-3 form">
                           <h2 class="text-center">Datos Usuario</h2>
                            <div class="form-group">
                                ...
                                <div class="div-input">
                                    <input type="text" name="idC" id="idC" value="" class="form-control m-auto col-sm-8 bg-secondary text-center" readonly>
                                    <span class=""></span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="div-input">
                                    <input type="text" name="nombre" id="nombre" value="" class="form-control m-auto col-sm-8 text-center">
                                    <span class=""></span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="div-input">
                                    <input type="text" id="apellido1" name="apellido1" value="" class="form-control m-auto col-sm-8 text-center"> 
                                    <span class=""></span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="div-input">
                                    <input type="text" id="apellido2" name="apellido2" value="" class="form-control m-auto col-sm-8 text-center"> 
                                    <span class=""></span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="div-input">
                                    <input type="email" id="email" name="email" value="" class="form-control m-auto col-sm-8 text-center">
                                    <span class=""></span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="div-input">
                                    <input type="text" id="dni" name="dni" value="" class="form-control m-auto col-sm-8 text-center"> 
                                    <span class=""></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="div-input">
                                    <input type="text" id="direccion" name="direccion" value="" class="form-control m-auto col-sm-8 text-center">
                                    <span class=""></span>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="div-input">
                               <select class="custom-select m-auto form-control col-sm-8  text-center" id="tipoUser" name="tipoUser">
